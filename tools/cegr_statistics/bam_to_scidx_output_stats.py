...
payload['statistics'] = stats_util.polish_statistics_for_pegr([stats_util.get_statistics(args.input, STATS, dbkey=args.dbkey, chrom_lengths_file=args.chrom_len_file)])
